...
<html lang="en-US" class="no-js">
  <head>
    ...
    <!-- include (theme) style -->
    <link href="<?= view_cache_safe(sprintf('/ui/themes/%s/build/css/main.css', $theme_name)) ?>" rel="stylesheet">
    ...
    <script src="<?= view_cache_safe('/ui/js/polyfills.js') ?>"></script>
    ...
    <link rel="stylesheet" type="text/css" href="<?= view_cache_safe(view_fetch_themed_filename('/css/bootstrap-select-1.13.3.css', $theme_name)) ?>">

    <!-- bootstrap dialog -->
    <link rel="stylesheet" type="text/css" href="<?= view_cache_safe(view_fetch_themed_filename('/css/bootstrap-dialog.css', $theme_name)) ?>">

    <!-- Font awesome -->
    <link rel="stylesheet" href="<?= view_cache_safe('/ui/css/font-awesome.min.css') ?>">
    ...
    <script>
        ...
        <script src="<?= view_cache_safe('/ui/js/tokenize2.js') ?>"></script>
        <link rel="stylesheet" type="text/css" href="<?= view_cache_safe(view_fetch_themed_filename('/css/tokenize2.css', $theme_name)) ?>" rel="stylesheet" />

        <!-- Bootgrid (grid system from http://www.jquery-bootgrid.com/ )  -->
        <link rel="stylesheet" type="text/css" href="<?= view_cache_safe(view_fetch_themed_filename('/css/jquery.bootgrid.css', $theme_name)) ?>" />
        <script src="<?= view_cache_safe('/ui/js/jquery.bootgrid.js') ?>"></script>
        <!-- Bootstrap type ahead -->
        <script src="<?= view_cache_safe('/ui/js/bootstrap3-typeahead.min.js') ?>"></script>

        <!-- OPNsense standard toolkit -->
        <script src="<?= view_cache_safe('/ui/js/opnsense.js') ?>"></script>
        <script src="<?= view_cache_safe('/ui/js/opnsense_theme.js') ?>"></script>
        <script src="<?= view_cache_safe('/ui/js/opnsense_ui.js') ?>"></script>
        <script src="<?= view_cache_safe('/ui/js/opnsense_bootgrid_plugin.js') ?>"></script>
  ...
  <main class="page-content col-sm-9 col-sm-push-3 col-lg-10 col-lg-push-2">
    ...
    <!-- bootstrap script -->
    <script src="<?= view_cache_safe('/ui/js/bootstrap.min.js') ?>"></script>
    <script src="<?= view_cache_safe('/ui/js/bootstrap-select.min.js') ?>"></script>
    <!-- bootstrap dialog -->
    <script src="<?= view_cache_safe('/ui/js/bootstrap-dialog.min.js') ?>"></script>
    <script>
