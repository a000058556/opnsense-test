<link href="<?= view_cache_safe('/ui/css/flags/flag-icon.css') ?>" rel="stylesheet">
<style>
...
<div class="tab-content content-box">
    ...
    <div id="geoip" class="tab-pane fade in">
      <?= $this->partial('layout_partials/base_form', ['fields' => $formGeoIPSettings, 'id' => 'frm_GeopIPSettings']) ?>
    </div>
</div>
