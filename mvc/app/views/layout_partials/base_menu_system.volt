                                ...
                                {% for subMenuItem in topMenuItem.Children %}
                                    ...
                                    {# next level items, submenu is a container #}
                                        ...
                                        <a href="#{{ topMenuItem.Id }}_{{ subMenuItem.Id }}" 
                                            class="menu-a-radius list-group-item {% if subMenuItem.Selected %}  active-menu-title {% endif  %} {% if subMenuItem.Id == 'DHCPv4' || subMenuItem.Id == 'DHCPv6' || subMenuItem.Id == 'Password'  %} hide {% endif  %}"
